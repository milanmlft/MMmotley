...
prim_col <- "#222A38"
sec_col <- "#1E64C8" # UGent blue
style_duo_accent(
  # base_color = "#43BF87",
  primary_color = prim_col,
  secondary_color = sec_col,
  link_color = sec_col,
  text_bold_color = sec_col,
  code_inline_color = sec_col,
  inverse_background_color = prim_col,
  header_font_google = google_font("Josefin Sans"),
  text_font_google   = google_font("Lora", "400", "400i", "600i", "700"),
